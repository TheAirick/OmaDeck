...
TestCase {
  ...
  function test_twoSiblingCardsAndRealClockTap() {
    ...
    compare(fixture.clockCard.padding, Style.spacing.panelPadding)
    ...
    var clockTime = findChild(fixture.clock, "clockTime")
    verify(clockTime !== null)
    var formerSize = Math.min(fixture.clock.width * 0.14,
      fixture.clock.height * 0.46, Style.font.displayLarge * 1.65)
    verify(clockTime.font.pixelSize >= formerSize * 1.2,
      "Clock time should use the added Weather-state height")
    ...
    compare(fixture.companionCard.title, "Weather")
    compare(fixture.companionCard.padding, Style.spacing.panelPadding)
    compareRect(rectIn(fixture.clockCard, tile), clockCardBefore, "Clock card after cancel")
    compareRect(rectIn(fixture.clock, tile), clockBefore, "Clock content after cancel")
    compareRect(rectIn(fixture.companionCard, tile), lowerBefore, "Weather card after cancel")
