...
- Settings UI for target screen, primary monitor, and input devices
- Add, remove, reorder, resize, and choose glyphs for launcher entries
...
- Notification and timer modules
